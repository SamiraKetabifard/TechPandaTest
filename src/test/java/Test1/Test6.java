...
public class Test6 {
    ...
    @Test
    public void verifyPurchaseWithRegisteredUser() throws InterruptedException {
        ...
        String flatRatePrice = driver.findElement(
                By.xpath(".//*[@id='co-shipping-method-form']/dl/dd/ul/li/label")
        ).getText();

        System.out.println("Actual shipping = " + flatRatePrice);
            //String flatRatePrice = driver.findElement(By.xpath
        // (".//*[@id='co-shipping-method-form']/dl/dd/ul/li/label")).getText();
            try {
        ...
        String shippingCostIncluded = driver.findElement(
                By.xpath(".//*[@id='shopping-cart-totals-table']/tbody/tr[2]/td[2]/span")
        ).getText();

        System.out.println("Actual shipping in total = " + shippingCostIncluded);
            //String shippingCostIncluded = driver.findElement(By.xpath
        // (".//*[@id='shopping-cart-totals-table']/tbody/tr[2]/td[2]/span")).getText();
